...
@Component({
  ...
  imports: [ModeToggleComponent, RouterLink, FormsModule, ReactiveFormsModule, JInputComponent, JLabelComponent, JContentFormComponent, ErrorMessageComponent, JButtonComponent, JCheckboxComponent]
})
